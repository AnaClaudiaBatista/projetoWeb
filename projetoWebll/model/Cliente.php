...
class Cliente{
    ...
    public function __construct($clienteid, $nome, $email, $telefone, $cpf, $senha, $tipo_usuario, $num_cartaocredito, $cvv_cartaocredito, $titular_cartaocredito, $vencimento_cartaocredito)
    {
    ...
    public function getCvv_cartaocredito() { return $this->senha; }
